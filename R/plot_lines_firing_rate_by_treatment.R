...
#'
#'@export
plot_lines_firing_rate_by_treatment <- function(
	experiment,
	plot_width=6,
	plot_height=6,
	...
	if(!is.null(output_base)){
	  ...
	  png_path <- paste0(output_base, "/lines_firing_rate_by_treatment_", experiment$tag, "_", date_code(), ".png")
	  if(verbose){
	    cat("Saving lines_firing_rate_by_treatment plot for experiment '", experiment$tag, "' to '", png_path, "'\n", sep="")
	  }
